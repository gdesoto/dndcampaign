...
export const characterSheetSchema = z
  .object({
    ...
    appearance: z
      ...
      .optional(),
    abilityScores: z.record(z.string(), z.any()).optional(),
    saves: z.array(z.record(z.string(), z.any())).optional(),
    skills: z.array(z.record(z.string(), z.any())).optional(),
    hitPoints: z.record(z.string(), z.any()).optional(),
    defenses: z.record(z.string(), z.any()).optional(),
    proficiencies: z.record(z.string(), z.any()).optional(),
    features: z.array(z.record(z.string(), z.any())).optional(),
    attacks: z.array(z.record(z.string(), z.any())).optional(),
    spells: z.record(z.string(), z.any()).optional(),
    equipment: z.array(z.record(z.string(), z.any())).optional(),
    inventory: z.record(z.string(), z.any()).optional(),
    resources: z.array(z.record(z.string(), z.any())).optional(),
    conditions: z.array(z.record(z.string(), z.any())).optional(),
    notes: z.record(z.string(), z.any()).optional(),
    portrait: z.record(z.string(), z.any()).optional(),
    allies: z.array(z.record(z.string(), z.any())).optional(),
    organizations: z.array(z.record(z.string(), z.any())).optional(),
    companions: z.array(z.record(z.string(), z.any())).optional(),
