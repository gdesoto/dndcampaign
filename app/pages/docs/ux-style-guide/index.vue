    ...
    <UPageBody class="space-y-8">
      <section id="use-this-guide" class="space-y-4 scroll-mt-28">
        <UCard class="self-start">
          <div class="space-y-4">
            <p class="text-xs uppercase tracking-[0.08em] text-[var(--ui-text-dimmed)]">How to use this guide</p>
            <h2 class="text-[var(--ui-text-highlighted)] type-section">Build interfaces that feel like a campaign desk, not a generic admin tool.</h2>
      ...
      <section id="pillars" class="space-y-4 scroll-mt-28">
        <div class="space-y-2">
          <h2 class="uppercase text-[var(--ui-text-dimmed)] type-section">Core pillars</h2>
          <p class="max-w-3xl text-sm leading-7 text-[var(--ui-text-muted)]">
        ...
        <div class="grid gap-4 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          ...
          <UCard class="self-start">
            <template #header>
              <h3 class="text-[var(--ui-text-highlighted)] type-record">Campaign desk snapshot</h3>
            </template>
      ...
      <section id="pages" class="space-y-4 scroll-mt-28">
        <div class="space-y-2">
          <h2 class="uppercase text-[var(--ui-text-dimmed)] type-section">Explore the guide</h2>
          <p class="max-w-3xl text-sm leading-7 text-[var(--ui-text-muted)]">
          ...
          <UCard v-for="page in uxGuidePages" :key="page.to" class="self-start">
            <template #header>
              <div class="flex items-start justify-between gap-3">
                <div class="space-y-1">
                  <p class="text-xs uppercase tracking-[0.08em] text-[var(--ui-text-dimmed)]">Section</p>
                  <h3 class="text-[var(--ui-text-highlighted)] type-record">{{ page.title }}</h3>
                </div>
