  ...
  <UPage>
    ...
    <UPageBody class="space-y-8">
      ...
      <section id="character-cards" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Character Cards</h2>
              ...
              <div class="flex items-center justify-between gap-3">
                <div class="flex items-center gap-3">
                  ...
                  <div class="space-y-0.5">
                    <h3 class="text-highlighted type-record">{{ char.name }}</h3>
                    <p class="text-xs uppercase tracking-[0.08em] text-dimmed">
                      {{ char.class }} · {{ char.subclass }}
                    </p>
                    <p class="text-xs uppercase tracking-[0.08em] text-dimmed">{{ char.race }}</p>
                  </div>
                </div>
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-1.5">
                <div class="flex items-center justify-between">
                  <p class="text-xs uppercase tracking-[0.08em] text-dimmed">Hit Points</p>
              ...
              <div class="flex gap-2">
                <div class="flex flex-1 flex-col items-center rounded-lg border border-default bg-accented py-2 px-1">
                  <p class="text-xs uppercase tracking-[0.08em] text-dimmed">AC</p>
                  <p class="mt-0.5 font-display text-base text-highlighted">{{ char.ac }}</p>
                </div>
                <div class="flex flex-1 flex-col items-center rounded-lg border border-default bg-accented py-2 px-1">
                  <p class="text-xs uppercase tracking-[0.08em] text-dimmed">Speed</p>
                  <p class="mt-0.5 font-display text-base text-highlighted">{{ char.speed }}'</p>
                </div>
                <div class="flex flex-1 flex-col items-center rounded-lg border border-default bg-accented py-2 px-1">
                  <p class="text-xs uppercase tracking-[0.08em] text-dimmed">Perc.</p>
                  <p class="mt-0.5 font-display text-base text-highlighted">{{ char.passivePerception }}</p>
                </div>
                <div class="flex flex-1 flex-col items-center rounded-lg border border-default bg-accented py-2 px-1">
                  <p class="text-xs uppercase tracking-[0.08em] text-dimmed">Prof.</p>
      ...
      <section id="party-strip" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Party Strip</h2>
          <p class="text-sm text-muted">
          ...
          <UCard v-for="char in dndCharacters" :key="char.name" class="self-start">
            <div class="flex flex-col items-center gap-2 text-center">
              ...
              <div>
                ...
                <p class="text-xs uppercase tracking-[0.08em] text-dimmed mt-0.5">{{ char.class }}</p>
              </div>
              ...
              <div class="w-full space-y-1">
                ...
                <p class="text-xs text-dimmed">{{ char.hp }}<span class="opacity-50">/{{ char.maxHp }}</span></p>
              </div>
      ...
      <section id="quest-log" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Quest Log — Detailed</h2>
          <p class="text-sm text-muted">
        ...
        <div class="grid gap-4 lg:grid-cols-[1.4fr_1fr] lg:items-start">
          ...
          <UCard class="self-start">
            <template #header>
              <div class="space-y-2">
                <div class="flex items-start justify-between gap-3">
                  <h3 class="text-highlighted type-record">{{ dndDetailedQuest.title }}</h3>
                ...
                <div class="flex items-center gap-2">
                  ...
                  <p class="text-xs uppercase tracking-[0.08em] text-dimmed">{{ dndDetailedQuest.patron }}</p>
                </div>
              </div>
            </template>
            ...
            <!-- Objectives -->
            <div class="space-y-2">
              <p class="text-xs uppercase tracking-[0.08em] text-dimmed">Objectives</p>
              <ul class="space-y-2">
                <li
            ...
            <UCard class="self-start">
              <template #header>
                <div class="flex items-center gap-2">
                  ...
                  <h3 class="text-highlighted type-record">Reward</h3>
                </div>
              </template>
            ...
            <UCard class="self-start border-l-2 border-l-warning-500/60">
              <template #header>
                <div class="flex items-center gap-2">
                  ...
                  <h3 class="text-highlighted type-record">Next Hook</h3>
                </div>
              </template>
      ...
      <section id="initiative-tracker" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Initiative Tracker</h2>
          <p class="text-sm text-muted">
          ...
          <template #header>
            <div class="flex items-center justify-between gap-3">
              <div class="flex items-center gap-2">
                ...
                <h3 class="text-highlighted type-record">Round 3 · Flooded Chapel</h3>
              </div>
          ...
          <div class="divide-y divide-[var(--ui-border)]">
            ...
            >
              ...
              <div class="flex w-8 shrink-0 flex-col items-center">
                ...
                <p class="mt-0.5 text-xs text-dimmed">{{ combatant.initiative }}</p>
              </div>
              ...
              <div class="min-w-0 flex-1 space-y-1.5">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-xs uppercase tracking-[0.08em]" :class="combatantTypeColor(combatant.type)">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <p class="shrink-0 text-xs tabular-nums text-muted">
      ...
      <section id="conditions" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Condition Reference</h2>
          <p class="text-sm text-muted">
        ...
        <UCard>
          ...
          <div class="mt-4 grid gap-3 sm:grid-cols-3">
            <div class="rounded-lg border border-error-500/30 bg-error-500/5 p-3 space-y-1">
              <p class="text-xs uppercase tracking-[0.08em] text-error-400">Critical (red)</p>
            ...
            <div class="rounded-lg border border-warning-500/30 bg-warning-500/5 p-3 space-y-1">
              <p class="text-xs uppercase tracking-[0.08em] text-warning-400">Impaired (yellow)</p>
            ...
            <div class="rounded-lg border border-info-500/30 bg-info-500/5 p-3 space-y-1">
              <p class="text-xs uppercase tracking-[0.08em] text-info-400">Active / Positive (blue)</p>
      ...
      <section id="faction-cards" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Faction Cards</h2>
          <p class="text-sm text-muted">
        ...
        <div class="grid gap-4 md:grid-cols-3">
          ...
          >
              ...
              <div class="space-y-2">
                <div class="flex items-start justify-between gap-2">
                  <div class="flex items-center gap-2.5">
                    ...
                    <h3 class="text-highlighted type-record">{{ faction.name }}</h3>
                  </div>
                  <UBadge
            ...
            <div class="space-y-3">
              <div class="space-y-1">
                <p class="text-xs uppercase tracking-[0.08em] text-dimmed">Territory</p>
                <p class="text-sm text-muted">{{ faction.territory }}</p>
              </div>
              <div class="space-y-1">
                <p class="text-xs uppercase tracking-[0.08em] text-dimmed">Influence</p>
              ...
              <div class="space-y-1">
                <p class="text-xs uppercase tracking-[0.08em] text-dimmed">Key NPCs</p>
      ...
      <section id="spell-slots" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Spell Slot Tracker</h2>
          <p class="text-sm text-muted">
        ...
        <div class="grid gap-4 lg:grid-cols-2 lg:items-start">
          <UCard class="self-start">
            <template #header>
              <div class="flex items-center justify-between gap-3">
                <div class="flex items-center gap-2">
                  ...
                  <div>
                    <h3 class="text-highlighted type-record">Vesper</h3>
                    <p class="text-xs uppercase tracking-[0.08em] text-dimmed">Wizard · Level 5</p>
                  </div>
                </div>
            ...
            <div class="space-y-3">
              ...
              >
                <p class="w-14 shrink-0 text-xs uppercase tracking-[0.08em] text-dimmed">
                  Level {{ slot.level }}
                </p>
          ...
          <UCard class="self-start">
            <template #header>
              <h3 class="text-highlighted type-record">Design notes</h3>
            </template>
      ...
      <section id="threat-clocks" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Threat Clocks</h2>
          <p class="text-sm text-muted">
        ...
        <div class="grid gap-4 md:grid-cols-3">
          ...
          >
              ...
              <div class="space-y-1">
                <div class="flex items-center justify-between gap-2">
                  <div class="flex items-center gap-2">
                    ...
                    />
                    <h3 class="text-highlighted type-record">{{ clock.name }}</h3>
                  </div>
            ...
            <div class="space-y-3">
              ...
              >
                <p class="text-xs uppercase tracking-[0.08em]" :class="`text-${clock.urgency}-400`">
                  When filled
                </p>
      ...
      <section id="loot-items" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Loot &amp; Item Cards</h2>
          <p class="text-sm text-muted">
              ...
              <div class="space-y-1.5">
                <div class="flex items-start justify-between gap-2">
                  <div class="flex items-start gap-2.5">
                    ...
                    <div>
                      <h3 class="text-highlighted leading-tight type-record">{{ item.name }}</h3>
                      <p class="text-xs uppercase tracking-[0.08em] text-dimmed">{{ item.type }}</p>
                    </div>
                  </div>
                  <UBadge
      ...
      <section id="location-cards" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Location Cards</h2>
          <p class="text-sm text-muted">
          ...
          >
            <template #header>
              <div class="flex items-start justify-between gap-2">
                <div class="flex items-start gap-2.5">
                  ...
                  <div>
                    <h3 class="text-highlighted type-record">{{ loc.name }}</h3>
                    <p class="text-xs uppercase tracking-[0.08em] text-dimmed">{{ loc.region }}</p>
                  </div>
                </div>
                <div class="flex flex-col items-end gap-1">
                  ...
                  <div class="flex items-center gap-1">
                    ...
                    <p class="text-xs text-dimmed">{{ dangerLabel(loc.dangerLevel) }}</p>
                  </div>
                </div>
              </div>
            </template>
            ...
            <div class="space-y-3">
              ...
              <div v-if="loc.connectedQuests.length" class="space-y-1.5">
                <p class="text-xs uppercase tracking-[0.08em] text-dimmed">Connected Quests</p>
                <div class="flex flex-wrap gap-1.5">
                  <UBadge
      ...
      <section id="session-list" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Session List</h2>
          <p class="text-sm text-muted">
        ...
        <UCard>
          <template #header>
            <div class="flex items-center justify-between gap-3">
              <h3 class="text-highlighted type-record">Emberfall: Bells Beneath the Archive</h3>
      ...
      <section id="quest-list" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Quest List</h2>
          <p class="text-sm text-muted">
        ...
        <UCard>
          <template #header>
            <div class="flex items-center justify-between gap-3">
              <h3 class="text-highlighted type-record">Active Campaign Quests</h3>
              <div class="flex gap-1.5">
          ...
          <div class="divide-y divide-[var(--ui-border)]">
            ...
            >
              ...
              <div class="flex-1 min-w-0 space-y-0.5">
                ...
                <p class="text-xs text-dimmed">{{ quest.patron }}</p>
              </div>

              <!-- Updated -->
              <p class="shrink-0 text-xs text-dimmed tabular-nums hidden sm:block">{{ quest.updated }}</p>
      ...
      <section id="npc-list" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">NPC List</h2>
          <p class="text-sm text-muted">
        ...
        <UCard>
          <template #header>
            <div class="flex items-center justify-between gap-3">
              <h3 class="text-highlighted type-record">Named Characters</h3>
          ...
          <div class="divide-y divide-[var(--ui-border)]">
            ...
            >
              ...
              <!-- Last seen -->
              <p class="shrink-0 text-xs text-dimmed hidden md:block">{{ npc.lastSeen }}</p>
      ...
      <section id="location-list" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Location List</h2>
          <p class="text-sm text-muted">
        ...
        <UCard>
          <template #header>
            <div class="flex items-center justify-between gap-3">
              <h3 class="text-highlighted type-record">Known Locations</h3>
          ...
          <div class="divide-y divide-[var(--ui-border)]">
            ...
            >
              ...
              <div class="flex-1 min-w-0 space-y-0.5">
                ...
                <p class="text-xs text-dimmed">{{ loc.region }}</p>
              </div>

              <!-- Quest count -->
              <div class="hidden items-center gap-1 sm:flex shrink-0">
                <UIcon name="i-lucide-scroll-text" class="h-3 w-3 text-dimmed" />
                <p class="text-xs text-dimmed">{{ loc.connectedQuests.length }} quest{{ loc.connectedQuests.length !== 1 ? 's' : '' }}</p>
              </div>
      ...
      <section id="milestones" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Milestones</h2>
          <p class="text-sm text-muted">
        ...
        <UCard>
          <template #header>
            <div class="flex items-center justify-between gap-3">
              <h3 class="text-highlighted type-record">Campaign Progress</h3>
              <div class="flex items-center gap-2">
          ...
          <div class="relative space-y-0">
            ...
            >
              ...
              <div class="flex-1 min-w-0 space-y-1">
                ...
                <p class="text-xs uppercase tracking-[0.08em] text-dimmed">{{ milestone.arc }}</p>
              </div>
            </div>
          </div>
      ...
      <section id="audio-playlist" class="scroll-mt-28 space-y-4">
        <div class="space-y-1">
          <h2 class="text-highlighted type-section">Recap Audio Playlist</h2>
          <p class="text-sm text-muted">
          ...
          <template #header>
            <div class="flex items-center justify-between gap-3">
              <div class="flex items-center gap-2">
                ...
                <h3 class="text-highlighted type-record">Session Recordings</h3>
              </div>
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <div class="hidden flex-col items-end gap-0.5 sm:flex shrink-0">
                  ...
                  <p class="text-xs text-dimmed">{{ track.date }} · {{ track.fileSize }}</p>
                </div>
              ...
              <div v-if="activeTrackIndex === idx" class="mt-3 space-y-2 pl-11">
                <div class="flex items-center gap-2">
                  <p class="text-xs text-dimmed tabular-nums">0:00</p>
                  ...
                  <p class="text-xs text-dimmed tabular-nums">{{ track.duration }}</p>
                </div>
                <div class="flex items-center gap-2">
                  ...
                  <span class="ml-auto text-xs text-dimmed">1× speed</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <template #right>
      <UPageAside>
        <UCard>
          <template #header>
            <h3 class="uppercase text-dimmed type-record">
              On This Page
            </h3>
          </template>
