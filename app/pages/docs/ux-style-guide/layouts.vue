    ...
    <UPageBody class="space-y-8">
      <section id="guidelines" class="space-y-4 scroll-mt-28">
        <UCard v-for="guideline in layoutGuidelines" :key="guideline.title">
          <template #header>
            <div class="space-y-1">
              <h2 class="text-[var(--ui-text-highlighted)] type-section">{{ guideline.title }}</h2>
      ...
      <section id="dashboard" class="space-y-4 scroll-mt-28">
        <UCard>
          <template #header>
            <h2 class="text-[var(--ui-text-highlighted)] type-section">Demonstration: dashboard layout</h2>
          </template>
          ...
          <div class="space-y-4">
            <div class="flex flex-wrap items-start justify-between gap-3 rounded-xl border border-[var(--ui-border)] bg-[var(--ui-bg-accented)] p-5">
              <div>
                <p class="text-xs uppercase tracking-[0.08em] text-[var(--ui-text-dimmed)]">Header region</p>
...
v-for="card in dashboardPreviewCards"
      ...
      <section id="campaign" class="space-y-4 scroll-mt-28">
        <UCard>
          <template #header>
            <h2 class="text-[var(--ui-text-highlighted)] type-section">Demonstration: campaign route and scene prep</h2>
          </template>
          ...
          <div class="space-y-4">
            <div class="rounded-xl border border-[var(--ui-border)] bg-[var(--ui-bg-accented)] p-5">
              <div class="flex flex-wrap items-start justify-between gap-3">
                <div>
                  <p class="text-xs uppercase tracking-[0.08em] text-[var(--ui-text-dimmed)]">Campaign header</p>
...
v-for="zone in campaignViewZones"
                ...
                class="self-start"
              >
                <p class="text-xs uppercase tracking-[0.08em] text-[var(--ui-primary)]/75">{{ zone.eyebrow }}</p>
            ...
            <div class="grid gap-3 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
              <div class="space-y-3 rounded-[1.25rem] border border-[var(--ui-border)] bg-[var(--ui-bg-elevated)] p-5">
                <div class="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    <p class="text-xs uppercase tracking-[0.08em] text-[var(--ui-text-dimmed)]">Session scene board</p>
...
v-for="scene in scenePrepCards"
                    ...
                    class="self-start"
                  >
                    <p class="text-xs uppercase tracking-[0.08em] text-[var(--ui-primary)]/75">{{ scene.eyebrow }}</p>
              ...
              <UCard variant="soft" class="self-start">
                <template #header>
                  <h3 class="text-[var(--ui-text-highlighted)] type-record">Ritual clock</h3>
                </template>
      ...
      <section id="characters" class="space-y-4 scroll-mt-28">
        <UCard>
          <template #header>
            <h2 class="text-[var(--ui-text-highlighted)] type-section">Demonstration: character page layout</h2>
          </template>
          ...
          <div class="space-y-4">
            <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              <div
                ...
                class="rounded-lg border border-[var(--ui-border)] bg-[var(--ui-bg-accented)] p-3"
              >
                <p class="text-xs uppercase tracking-[0.08em] text-[var(--ui-text-dimmed)]">{{ stat.label }}</p>
            ...
            <div class="grid gap-3 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
              <UCard variant="soft" class="self-start">
                <template #header>
                  <h3 class="text-[var(--ui-text-highlighted)] type-record">High-frequency play data</h3>
                </template>
                ...
                <div class="space-y-3">
                  <div
                    ...
                    class="rounded-lg border border-[var(--ui-border)] bg-[var(--ui-bg-accented)] p-3"
                  >
                    <p class="text-xs uppercase tracking-[0.08em] text-[var(--ui-primary)]/80">{{ section.eyebrow }}</p>
              ...
              <UCard variant="soft" class="self-start">
                <template #header>
                  <h3 class="text-[var(--ui-text-highlighted)] type-record">Secondary information</h3>
                </template>
